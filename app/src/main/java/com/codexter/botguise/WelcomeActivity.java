...
//        }
    ...
    private void addBottomDots(int currentPage) {
        ...
        for (int i = 0; i < dots.length; i++) {
            ...
            dots[i].setColorFilter(colorsInactive[currentPage], PorterDuff.Mode.SRC_OVER);
            dotsLayout.addView(dots[i]);
        }

        if (dots.length > 0)
            dots[currentPage].setColorFilter(colorsActive[currentPage], PorterDuff.Mode.SRC_OVER);
    }
